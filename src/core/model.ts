...
export interface Media {
  ...
  thumb?: string;
  /**
   * Размеры из разметки Telegram. Нужны, чтобы браузер занял место под картинку
   * до её загрузки: иначе дозагрузка сдвигает текст под курсором чтения и, что
   * хуже, утаскивает восстановленную позицию.
   */
  width?: number;
  height?: number;
